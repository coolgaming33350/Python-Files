...
EMAIL_ADDRESS = 'carter.spenner@gmail.com'
KEY = 'b7acc841-2a38-454e-98ce-3a90a3a85edf'
...
BASE64_FILE_CONTENT = base64.b64encode(b'BRUUUUUUUUUUUUUUUUUUUUUU what is up guys welcome back to a brand new minecraft video').decode('utf8')  # or read your file and convert it into BASE64 presentation.
FILENAME = "hello.txt"
